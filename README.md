...
| Skill | Description |
|-------|-------------|
| `modal` | Core Modal platform patterns — app structure, function types, CLI, deployment. Auto-triggers when code imports `modal`. |
...
cp -R modal-auto-research-skills/{modal,modal-gpu-dev,modal-gpu-experiment,sub-agents} \
...
- modal: general Modal platform usage and patterns
